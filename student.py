...
#1st
        img=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\face-recognition.png")
...
#2nd
        img1=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\smart-attendance.jpg")
        img1=img1.resize((450,110),Image.ANTIALIAS)
...
#3rd
        img2=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\iStock-182059956_18390_t12.jpg")
        img2=img2.resize((450,110),Image.ANTIALIAS)
...
#bg image
        img3=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\wp2551980.jpg")
        img3=img3.resize((1620,780),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=110,width=1300,height=530)
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM ",font=("times new roman",15,"bold"),bg="white",fg="dark green")
        title_lbl.place(x=0,y=0,width=1430,height=35)
        

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=12,y=38,width=1250,height=550)
        ...
        img_left=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\AdobeStock_303989091.jpeg")
        img_left=img_left.resize((600,100),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(Left_frame,image=self.photoimg_left)
        f_lbl.place(x=0,y=0,width=590,height=100)

        

         #current course

        current_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Course information",font=("times new roman",12,"bold"))
        current_frame.place(x=5,y=100,width=590,height=100)
        ...
        course_combo=ttk.Combobox(current_frame,textvariable=self.var_course,font=("times new roman",10,"bold"),state="readonly")

         

        
        course_combo["values"]=("Select Courses","BTECH","MBA","PHARMA")
        ...
        dep_label.grid(row=0,column=2,padx=5)

        dep_combo=ttk.Combobox(current_frame,textvariable=self.var_dep,font=("times new roman",10,"bold"),state="readonly")

         

        
        dep_combo["values"]=("Select Department","CSIT","IT","CSE","CS")
        dep_combo.current(0)
        ...
        year_combo=ttk.Combobox(current_frame,textvariable=self.var_year,font=("times new roman",10,"bold"),state="readonly")
        ...
        year_label=Label(current_frame,text="Semester",font=("times new roman",12,"bold"),bg="white")
        year_label.grid(row=1,column=2,padx=5)

        year_combo=ttk.Combobox(current_frame,textvariable=self.var_sem,font=("times new roman",10,"bold"),state="readonly")

         

        
        year_combo["values"]=("Select Semester","1st","2nd","3rd","5th","6th","7th","8th")
        year_combo.current(0)
        ...
        class_Student_frame.place(x=5,y=200,width=590,height=255)
...
#roll no
 ...
 #gender
       ...
       # gender_entry.grid(row=2,column=1,padx=10,pady=5,sticky=W) 
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_gender,font=("times new roman",10,"bold"),state="readonly",width=10)
...
#email
 ...
 #phone no.
        ...
        btn_frame.place(x=0,y=170,width=585,height=60)
        ...
        btn_frame1.place(x=0,y=255,width=585,height=20)

        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Photo Sample",width=20,font=("times new roman",10,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=1,column=0)

        update_btn1=Button(btn_frame,text="Update Photo Sample",width=20,font=("times new roman",10,"bold"),bg="blue",fg="white")
        ...
        Right_frame.place(x=620,y=0,width=620,height=480)
        

        img_right=Image.open(r"C:\Users\win\Desktop\Advance smart attendance\college_images\gettyimages-1022573162.jpg")
...
#table frame
        ...
        table_frame.place(x=5,y=165,width=610,height=290)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select department" or self.var_std_name.get()=="" or  self.va_std_id.get()=="":
            ...
            try:
                ...
                self.reset_data()
                conn.close()
                #load prededined data on face frontals from opencv
                face_classifier=cv2.CascadeClassifier("haarcascade_frontalface_default.xml") 
                def face_cropped(img):
                    gray=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
                    faces=face_classifier.detectMultiScale(gray,1.3,5)
                    #1.3 scaling factor
                    # 5-minimum neighbouur
